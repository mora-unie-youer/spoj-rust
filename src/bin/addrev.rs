 ...
 * tragedies. Therefore the dramatic advisor of ACM has decided to transfigure some tragedies into comedies. Obviously, this
 * work is very hard because the basic sense of the play must be kept intact, although all the things change to their
...
fn main() {
    ...
    for line in lines.take(n) {
        ...
        let (a, b) = (reverse_number(a), reverse_number(b));

        let result = reverse_number(a + b);
        println!("{}", result);
    }
}
